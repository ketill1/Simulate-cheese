...
for n=1:N % Main loop
    ...
    % Updatera positioner
    x_old=x_new;
    v_old=euler_half_step_backaward(v_new,step_size,x_new,v_new,NS,KS,KD,L); % Euler half step backwards
    F=my_force(x_new,v_new,NS,KS,KD,L);                    % Force calculation (may involve x_old and v_old)
    ...
    [a,b,c,d]=energy_ost(m,g,L,x_new,v_new,KS,NS,NP);
    E_tot(1,n)=a;
    E_p(1,n)=b;
    E_s(1,n)=c;
    E_k(1,n)=d;
